...
import pl.java.scalatech.domain.exercise.sample.Address;
...
public abstract class ORMStandaloneClassTestCase {
    ...
    public static void setup() {
        ...
        log.info("+++ setup");
        metadata = new MetadataSources(srb.build()).addAnnotatedClass(Employee.class).addAnnotatedClass(Address.class)
                .addAnnotatedClass(Department.class).addAnnotatedClass(Phone.class).addAnnotatedClass(Project.class).buildMetadata();
